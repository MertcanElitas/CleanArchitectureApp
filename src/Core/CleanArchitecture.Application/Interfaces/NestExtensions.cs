...
namespace CleanArchitecture.Application.Interfaces
{
    public static class NestExtensions
    {
        ...
        {
            var fields = typeof(T).GetProperties().Select(p => p.Name.ReplaceFirstCharacterToLowerVariant()).ToArray();
        ...
        public static string ReplaceFirstCharacterToLowerVariant(this string name)
        {
            var firstChar = (byte)name.First();
            return string.Format("{0}{1}", (char)(firstChar + 32), name.Substring(1));
        }
